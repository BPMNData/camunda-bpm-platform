 ...
 */
public class StartBpmnDataAwareProcessInstanceCmd implements Command<ProcessInstance>, Serializable {
  ...
  public StartBpmnDataAwareProcessInstanceCmd(String processDefinitionKey, String processDefinitionId, Map<String, Object> variables, String caseObjectId) {
  ...
  public ProcessInstance execute(CommandContext commandContext) {
    ...
    processInstance.setCaseObjectID(caseObjectId);
