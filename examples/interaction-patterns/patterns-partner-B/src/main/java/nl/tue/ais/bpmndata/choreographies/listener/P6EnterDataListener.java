 ...
 * @author dfahland
 */
public class P6EnterDataListener implements TaskListener {
  ...
  public void notify(DelegateTask delegateTask) {
    ...
    addAttribute(xmlBuilder, delegateTask, "text");
    addAttribute(xmlBuilder, delegateTask, "conversationNumber");
    xmlBuilder.append("</DataObjectB>");
